 ...
 */
class Localidad extends \DBAL\Entity\Localidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'Id', 'nombre', '' . "\0" . 'DBAL\\Entity\\Localidad' . "\0" . 'personas'];
        }
     ...
     * {@inheritDoc}
     */
    public function addPersona(\DBAL\Entity\Persona $persona)
    {
